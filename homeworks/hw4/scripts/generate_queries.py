...
"""
    ...
    def generate_realistic_query(
        self, recipe: Dict[str, Any], salient_fact: str
    ) -> str:
        """
...
"""
    ...
    def generate_queries_parallel(
        ...
        target_recipes = shuffled_recipes[
            : max_queries * 2
        ]  # Process more to account for failures
    ...
    def print_sample_queries(
        self, queries: List[Dict[str, Any]], n_samples: int = 5
    ) -> None:
