...
class QueryReviewer:
    ...
    def review_queries_interactive(
        self, queries: List[Dict[str, Any]], max_review: int = 20
    ) -> List[Dict[str, Any]]:
    ...
    def batch_filter_queries(
        self, queries: List[Dict[str, Any]], criteria: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
    ...
    def save_reviewed_queries(
        self, queries: List[Dict[str, Any]], output_path: Path
    ) -> None:
    ...
    def print_review_summary(
        self, original_count: int, reviewed_queries: List[Dict[str, Any]]
    ) -> None:
...
def main():
    ...
    if mode in ["2", "3"]:
        ...
        if mode == "2":
            ...
            reviewed_queries = reviewer.review_queries_interactive(
                filtered_queries, max_review=10
            )
